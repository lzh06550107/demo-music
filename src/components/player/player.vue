        ...
        <div class="bottom">
          ...
          <div class="operators">
            ...
            <div class="icon i-right">
              <i :class="favorite" @click.stop="toggleFavoriteSong"></i>
            </div>
          </div>
        </div>
      </div>
...
const transform = prefixStyle('transform')
  ...
  export default {
    ...
    methods: {
      ...
      middleTouchStart(e) { // 触摸开始
        this.touch.initiated = true
        const touch = e.touches[0]
        this.touch.startX = touch.pageX
        this.touch.startY = touch.pageY
      },
      middleTouchMove(e) { // 触摸滑动
    ...
    watch: {
      currentSong(newSong, oldSong) {
        ...
        this.isFavorite = this.favoriteList.some(item => {
